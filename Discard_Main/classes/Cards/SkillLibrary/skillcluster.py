...
class BasicShield(card.Skill):
    def __init__(self, name = "BasicShield", trigger = "auto", target=("This","Ally", "x1"), type="other", limit = "", description = "Reduce Damage From a incoming Attack by a set amount", shield_amount = 1):
