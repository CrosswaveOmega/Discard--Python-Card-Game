...
class Piece:
    ...
    def get_move_options(self, grid): #Wip function.
        ...
        print(grid.get_all_in_range(self.position, "SAME COLUMN"))
        print(grid.get_all_in_range(self.position, "SAME ROW"))
        print(grid.get_all_in_range(self.position, "SAME COLUMN LIMIT 1"))
        print(grid.get_all_in_range(self.position, "SAME ROW LIMIT 1"))
